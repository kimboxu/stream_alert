...
class ChatAnalyzer:
    ...
    def __init__(self, init: initVar, channel_id: str, channel_name: str = ""):
        ...
        'excitement': re.compile(r'!{1,}|\?{2,}|ㄷ{2,}|ㄱ{2,}|ㅏ{2,}|헐|대박|캬|^와|^오$|^오(?!\S)|^오우|^오이|^옹|^올$|우와|미친|ㅁㅊ|나이스|ㄴㅇㅅ|개쩔|쩐다|고고|가즈아|ㅗㅜㅑ'),
        'surprise': re.compile(r'^\s*\?\s*$|헉|왓|뭣|뭐야|뭐여|무야|어라|어래|어머|어떻게|진짜|실화|레전드|띠용|충격|놀람|지리네|o0o|O0O|0o0'),
        'reaction': re.compile(r'ㅠ{2,}|ㅜ{2,}|ㅎㅇㅌ|ㄹㅇ|앗|아악|아니|안돼|제발|부탁|응원'),
